...
////////////////////////////////////////////////////////////////////////////////////////////////////
	function GenerateHTMLTextSeite1($Startdatum, $Enddatum, $MieterID)
	{
	  ...
	  <br/>';
		...
		$text .= '
			<div  style="font-weight: bold; font-size: 12pt; padding: 8px;">
		...
		<table width="100%">
			<tr>
				<td width="50%" style="text-align: left;padding: 8px;font-size: 10pt;">
					Betrag excl. MwSt.
				</td>
				<td width="50%" style="text-align: right;padding: 8px;font-size: 10pt;">
    ...
    private function GenerateHTMLTextSeite2($Startdatum, $Enddatum, $MieterID)
    {
		...
		<thead>
		<tr>
		  <th style="width: 25%; text-align: left; padding: 8px; font-size: 10pt;">
			Bezug
		  </th>
		  <th style="width: 25%; text-align: right; padding: 8px; font-size: 10pt;">
			Tarif
		  </th>
		  <th style="width: 25%; text-align: right; padding: 8px; font-size: 10pt;">
			Rabatt
		...
		$text .= '<tr>
			...
			<td style="text-align: right; padding: 8px;border-bottom: 1px solid black; font-size: 10pt;">CHF/kWh</td>
		...
		$text .= '<tr>
			...
			<td style="text-align: right; padding: 8px; font-size: 10pt;">'.strval($tariff).'</td>
			<td style="text-align: right; padding: 8px; font-size: 10pt;">'.$this->removeKomma(number_format($Rabatt, 2)).'</td>
			<td style="text-align: right; padding: 8px; font-size: 10pt;">'.$this->removeKomma(number_format($Betrag, 2)).'</td>
		</tr>
         </table>';
		...
		<tr>
		  ...
		  <th style="width: 55%; text-align: left; padding: 8px;font-size: 10pt;">
			Zähler
		  </th>
		  <!-- Rechtsbündig, 15% Breite -->
		  <th style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;">
			Bezug
		  </th>
		  <!-- Rechtsbündig, 15% Breite -->
		  <th style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;">
		...
		<td style="width: 55%; text-align: left; border-bottom: 1px solid black; padding: 8px;font-size: 10pt;"></td>
		<td style="width: 15%; text-align: right; border-bottom: 1px solid black; padding: 8px;font-size: 10pt;">kWh</td>
		<td style="width: 15%; text-align: right; border-bottom: 1px solid black; padding: 8px;font-size: 10pt;">%</td>
		<td style="width: 15%; text-align: right; border-bottom: 1px solid black; padding: 8px;font-size: 10pt;">kWh</td>
	    </tr>';
		...
		foreach ($data as $key  => $variable) 
		{
			...
			$text .= '<tr>
					<td style="width: 55%; text-align: left; padding: 8px;font-size: 10pt;">'.$name.'</td>
					<td style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;">'.$this->removeKomma(number_format($consumption,2)).'</td>
					<td style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;">'.$this->removeKomma(number_format($percentage,2)).'</td>
					<td style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;">'.$this->removeKomma(number_format($consumptioncalc,2)).'</td>
				</tr>';
		...
		$text .= '
            ...
            <table border-collapse: collapse; width="100%">
                <tr>
 					<td style="width: 55%; text-align: left; padding: 8px;font-size: 10pt;"></td>
					<td style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;"></td>
					<td style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;"></td>
					<td style="width: 15%; text-align: right; padding: 8px;font-size: 10pt;">'.$this->removeKomma(number_format($Bezug,2)).'</td>
